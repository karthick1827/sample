...
upstream_documents_read: ["architecture.md", "brief.md", "prd.md"]
---

**Epics & User Stories Breakdown for Fleet 360 Login Portal and Landing Experience**

**Document ID:** EUS-Fleet-360-Login-Landing-2026-09-01
**Status:** In Review
**Created:** 2026-09-01
**Updated:** 2026-09-01
**Reviewers:** [List of reviewers assigned to this EUS]
...
12. [Risks & Mitigation Strategies](#risks--mitigation-strategies)
...
16. [Usability Requirements](#usability-requirements)
17. [Accessibility Requirements](#accessibility-requirements)
18. [Internationalization & Localization Requirements](#internationalization--localization-requirements)
19. [Testing & Quality Assurance](#testing--quality-assurance)
20. [Deployment & Operations](#deployment--operations)
21. [Maintenance & Support](#maintenance--support)

**Introduction**

The Fleet 360 Login Portal and Landing Experience is a critical component of the Fleet 360 platform, providing a secure, branded authentication entry point paired with an intuitive post-login launchpad. This Epics & User Stories Breakdown outlines the requirements for the development of this feature, ensuring that it meets the needs of the target audience and aligns with the overall vision of the Fleet 360 platform.
...
1. **Epic 1: Secure Authentication**
	* User authentication and authorization
	* Password hashing and salting
	* Enterprise single-sign-on (SSO)
2. **Epic 2: Intuitive Landing Experience**
	* Clean welcome typography
	* Three high-contrast navigation cards
	* Client-side route protection and token-based session persistence
3. **Epic 3: Role-Optimized Entry**
	* Role-based access control
	* Fine-grained RBAC permission matrix editor
	* LDAP directory sync

**User Stories**

1. **User Story 1: As a facility operations manager, I want to check overall campus health, floor-by-floor HVAC status, and multi-site footprints.**
	* Target landing destination: **Sites Module** (`/sites`)
	* Acceptance criteria: The user can view overall campus health, floor-by-floor HVAC status, and multi-site footprints.
2. **User Story 2: As a field technician / HVAC specialist, I want to inspect specific RTUs, adjust temperature setpoints, and diagnose alarm codes.**
	* Target landing destination: **Devices Module** (`/devices`)
	* Acceptance criteria: The user can inspect specific RTUs, adjust temperature setpoints, and diagnose alarm codes.
3. **User Story 3: As an enterprise IT / security admin, I want to invite new site managers, configure roles, and audit permissions.**
	* Target landing destination: **Users Module** (`/users`)
	* Acceptance criteria: The user can invite new site managers, configure roles, and audit permissions.
