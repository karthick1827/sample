...
acl-advanced-elicitation's pick_methods.py.)
...
<title>ACL Method Brainstorming Selection</title>
<script>
/* set the theme before first paint so there's no light-mode flash */
(function(){ try {
  var t = localStorage.getItem('acl-theme');
...
<header>
  <div class="hwrap">
  <div class="titlerow">
    <h1>ACL Method Brainstorming Selection</h1>
...
<footer>ACL Method &middot; Brainstorming</footer>
<script>
(function(){
  ...
  themeBtn.addEventListener('click', function(){
    ...
    try { localStorage.setItem('acl-theme', next); } catch(e){}
    setThemeIcon();
  });
