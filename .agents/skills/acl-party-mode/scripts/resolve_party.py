...
Merges the installed ACL agents with the user's custom `party_members`
...
def load_workflow(project_root: Path, skill_root: Path):
    ...
    script = project_root / "_acl" / "scripts" / "resolve_customization.py"
...
def main():
    ...
    ap.add_argument("--skill", required=True, help="Path to the acl-party-mode skill dir")
